...
const navGroups: NavGroup[] = [
  ...
  { label: 'Administration', icon: <Shield size={15} />, labelKey: 'nav.administration', roles: ['government', 'admin', 'super_admin'], defaultOpen: false,
    items: [
      ...
      { label: 'Off-plan Reviews', path: '/admin/offplan-reviews', icon: <Building2 size={20} />, roles: ['admin', 'super_admin'] },
  ...
  { label: 'Marketplace', icon: <Store size={15} />, roles: ['admin', 'super_admin'], defaultOpen: false,
    items: [
      { label: 'Storefronts', path: '/admin/storefronts', icon: <Store size={20} />, roles: ['admin', 'super_admin'] },
      { label: 'Transactions', path: '/admin/transactions', icon: <Receipt size={20} />, roles: ['admin', 'super_admin'] },
      { label: 'Sponsorships', path: '/admin/sponsorships', icon: <Megaphone size={20} />, roles: ['admin', 'super_admin'] },
      { label: 'Promotions', path: '/admin/promotions', icon: <TicketPercent size={20} />, roles: ['admin', 'super_admin'] },
