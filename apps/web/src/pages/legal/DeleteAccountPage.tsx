...
export function DeleteAccountPage() {
  return <main className="mx-auto max-w-3xl space-y-6 px-4 py-12">
    ...
    <PrivacyControls />
    <p>Deleted data can remain in our encrypted database backups until those backups expire. Account closures, and the documents, listings, listing photos, reviews, business listings, payout accounts and webhooks you delete, are recorded and applied again before any restored copy goes live. The <a className="underline" href="/privacy#retention">Privacy Policy</a> lists how long each kind of data is kept.</p>
