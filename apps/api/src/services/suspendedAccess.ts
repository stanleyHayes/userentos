...
export function suspendedAccess(method: string, originalUrl: string): boolean {
  ...
  if (method === 'GET') return [
    '/api/users/me', '/api/users/me/export', '/api/users/me/export.json', '/api/agreements', '/api/payments', '/api/payments/methods',
  ...
  if (method === 'POST') return [
    '/api/auth/change-password', '/api/auth/logout-all', '/api/auth/mfa/setup', '/api/auth/mfa/enable', '/api/auth/mfa/disable', '/api/payments', '/api/users/me/export-link',
