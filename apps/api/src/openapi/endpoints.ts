...
registry.registerPath({
  ...
  description: 'Returns the currently supported account, tenant profile, agreements, payments, applications, disputes, reviews, sent messages, wallet, wallet credits, savings, blocked contacts, Google store purchases, Apple purchases and up to 1000 audit records. Apple purchase exports contain ownership-scoped product, renewal, access and date fields; encrypted identifiers and internal recovery fields are excluded. Password hashes and MFA secrets are excluded. This export is sensitive personal data.',
  security: [{ bearerAuth: [] }],
  responses: {
