...
registry.registerPath({
  ...
  description: 'Returns the currently supported account, tenant profile, agreements, payments, applications, disputes, reviews, sent messages, wallet, savings and up to 1000 audit records. Password hashes and MFA secrets are excluded. This export is sensitive personal data.',
  security: [{ bearerAuth: [] }],
  responses: {
