              ...
              <ScrollView style={{ paddingHorizontal: spacing.md }} showsVerticalScrollIndicator={false}>
                <View style={s.detailHeader}>
                  ...
                  <View style={[s.verifyBadge, { backgroundColor: selectedUser.isVerified ? c.accent + '15' : c.muted + '15' }]}>
                    ...
                    <Text style={{ color: selectedUser.isVerified ? c.accent : c.muted, fontSize: 12, fontFamily: 'Outfit_600SemiBold' }}>
              ...
              >
                <Text
                  style={[
                    s.filterChipText,
                    { color: c.muted },
                    isActive && { color: c.primary, fontFamily: 'Outfit_600SemiBold' },
                  ]}
                >
                  {filter}
                </Text>
...
const s = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontSize: 14, fontFamily: 'Outfit_500Medium', paddingVertical: 0 },
  ...
  filterChipText: { fontSize: 12, fontFamily: 'Outfit_500Medium' },
  ...
  userEmail: { fontSize: 12, fontFamily: 'Outfit_400Regular', marginTop: 1 },
  badgeRow: { flexDirection: 'row', gap: 4, marginTop: 6, flexWrap: 'wrap' },
  roleBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
  roleBadgeText: { fontSize: 10, fontFamily: 'Outfit_600SemiBold', textTransform: 'capitalize' },
  statusCol: { alignItems: 'center', gap: 2, marginLeft: spacing.sm },
  statusText: { fontSize: 10, fontFamily: 'Outfit_500Medium' },
  ...
  detailSectionLabel: { fontSize: 10, fontFamily: 'Outfit_600SemiBold', textTransform: 'uppercase', letterSpacing: 1, marginTop: spacing.md, marginBottom: 6 },
  detailMono: { fontSize: 11, fontFamily: 'Outfit_400Regular', padding: 10, overflow: 'hidden' },
  ...
  deleteBtnText: { fontSize: 14, fontFamily: 'Outfit_600SemiBold' },
})
