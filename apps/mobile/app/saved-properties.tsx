...
const s = StyleSheet.create({
  ...
  browseBtnText: { color: '#fff', fontSize: 13, fontFamily: 'Outfit_600SemiBold' },
  ...
  statusBadgeText: { fontSize: 10, fontFamily: 'Outfit_700Bold', textTransform: 'capitalize' },
  ...
  locationText: { fontSize: 11, fontFamily: 'Outfit_400Regular' },
  price: { fontSize: 16, fontFamily: 'Outfit_800ExtraBold', marginTop: 4 },
  ...
  detailChipText: { fontSize: 11, fontFamily: 'Outfit_400Regular' },
  typeLabel: { fontSize: 11, fontFamily: 'Outfit_600SemiBold', textTransform: 'capitalize', marginLeft: 'auto' },
})
