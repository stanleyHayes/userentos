...
const s = StyleSheet.create({
  ...
  label: { fontSize: 13, fontFamily: 'Outfit_600SemiBold', marginTop: spacing.sm },
  chipRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 6 },
  chip: { paddingHorizontal: 12, paddingVertical: 6 },
  chipText: { fontSize: 12, fontFamily: 'Outfit_500Medium' },
  input: { paddingHorizontal: spacing.md, paddingVertical: 10, fontSize: 14, fontFamily: 'Outfit_400Regular', marginTop: 4 },
  textarea: { height: 100, textAlignVertical: 'top' },
  generateBtn: { marginTop: spacing.lg, paddingVertical: 14, borderRadius: 12, alignItems: 'center' },
  generateBtnText: { color: '#fff', fontSize: 15, fontFamily: 'Outfit_700Bold' },
  resultHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing.sm },
  resultTitle: { fontSize: 14, fontFamily: 'Outfit_700Bold' },
  resultText: { fontSize: 13, fontFamily: 'Outfit_400Regular', lineHeight: 20 },
})
