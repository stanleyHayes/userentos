...
const s = StyleSheet.create({
  ...
  setupTitle: { fontSize: 18, fontFamily: 'Outfit_800ExtraBold' },
  setupSub: { fontSize: 13, fontFamily: 'Outfit_400Regular', textAlign: 'center', lineHeight: 19 },
  ...
  bizName: { fontSize: 17, fontFamily: 'Outfit_800ExtraBold' },
  ...
  cityText: { fontSize: 12, fontFamily: 'Outfit_400Regular' },

  statRow: { flexDirection: 'row', gap: 6 },
  statBox: { flex: 1, padding: 10, gap: 2, alignItems: 'center' },
  statBoxValue: { fontSize: 16, fontFamily: 'Outfit_800ExtraBold' },
  statBoxLabel: { fontSize: 9, fontFamily: 'Outfit_500Medium', textTransform: 'uppercase', textAlign: 'center' },

  addBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingVertical: 11, borderRadius: 10 },
  addBtnText: { color: '#fff', fontSize: 14, fontFamily: 'Outfit_600SemiBold' },

  sectionLabel: { fontSize: 9, fontFamily: 'Outfit_700Bold', letterSpacing: 0.5, marginBottom: spacing.sm, marginTop: spacing.xs },
  empty: { alignItems: 'center', paddingVertical: 40, gap: spacing.sm },
  emptyTitle: { fontSize: 15, fontFamily: 'Outfit_600SemiBold' },
  ...
  listingTitle: { fontSize: 14, fontFamily: 'Outfit_700Bold' },
  listingDesc: { fontSize: 12, fontFamily: 'Outfit_400Regular', lineHeight: 17 },
  listingMeta: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, flexWrap: 'wrap' },
  listingPrice: { fontSize: 13, fontFamily: 'Outfit_700Bold' },
  promoText: { fontSize: 12, fontFamily: 'Outfit_700Bold', color: '#f59e0b' },
  inactiveText: { fontSize: 11, fontFamily: 'Outfit_500Medium', fontStyle: 'italic' },
  ...
  segmentText: { fontSize: 12, fontFamily: 'Outfit_700Bold' },
  ...
  inquiryMeta: { fontSize: 12, fontFamily: 'Outfit_500Medium', flex: 1 },
  inquiryPhone: { fontSize: 13, fontFamily: 'Outfit_600SemiBold', flex: 1 },
  inquiryDate: { fontSize: 11, fontFamily: 'Outfit_400Regular' },
  ...
  inquiryActionText: { fontSize: 12, fontFamily: 'Outfit_700Bold' },
