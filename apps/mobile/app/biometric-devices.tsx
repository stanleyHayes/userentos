...
const s = StyleSheet.create({
  ...
  subtitle: { fontSize: 13, fontFamily: 'Outfit_400Regular', marginBottom: spacing.sm },
  empty: { padding: spacing.xl, alignItems: 'center', gap: 8 },
  emptyTitle: { fontSize: 15, fontFamily: 'Outfit_700Bold' },
  emptyDesc: { fontSize: 13, fontFamily: 'Outfit_400Regular', textAlign: 'center' },
  card: { padding: spacing.md },
  cardRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.md },
  icon: { width: 40, height: 40, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  labelRow: { flexDirection: 'row', alignItems: 'center', gap: 8, flexWrap: 'wrap' },
  deviceLabel: { fontSize: 14, fontFamily: 'Outfit_700Bold' },
  thisBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
  thisBadgeText: { fontSize: 10, fontFamily: 'Outfit_700Bold', textTransform: 'uppercase' },
  meta: { fontSize: 12, fontFamily: 'Outfit_400Regular', marginTop: 2 },
  deviceIdText: { fontSize: 11, fontFamily: 'Outfit_400Regular', marginTop: 1 },
  revokeBtn: { borderWidth: 1, borderRadius: 8, paddingHorizontal: 14, paddingVertical: 8 },
  revokeText: { fontSize: 13, fontFamily: 'Outfit_600SemiBold' },
  ...
  revokeAllText: { fontSize: 14, fontFamily: 'Outfit_600SemiBold' },
})
