...
const s = StyleSheet.create({
  ...
  emptyDesc: { fontSize: 13, fontFamily: 'Outfit_400Regular', textAlign: 'center', lineHeight: 20, maxWidth: 300, marginBottom: spacing.lg },
  suggestions: { gap: spacing.sm, width: '100%', maxWidth: 340 },
  suggestion: { borderWidth: 1, borderRadius: 12, padding: 12 },
  suggestionText: { fontSize: 13, fontFamily: 'Outfit_500Medium' },
  chatArea: { flex: 1 },
  ...
  aiLabel: { fontSize: 10, fontFamily: 'Outfit_600SemiBold' },
  bubbleText: { fontSize: 14, fontFamily: 'Outfit_400Regular', lineHeight: 21 },
  ...
  textInput: { flex: 1, fontSize: 15, fontFamily: 'Outfit_400Regular', maxHeight: 100, paddingVertical: 8, paddingHorizontal: 12 },
