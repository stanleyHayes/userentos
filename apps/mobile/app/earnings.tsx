...
const s = StyleSheet.create({
  ...
  ratingValue: { fontSize: 16, fontFamily: 'Outfit_800ExtraBold' },
  ratingCount: { fontSize: 12, fontFamily: 'Outfit_400Regular' },
  chartRow: { flexDirection: 'row', alignItems: 'flex-end', gap: 8, marginTop: spacing.md, height: 140 },
  chartCol: { flex: 1, alignItems: 'center', gap: 4 },
  chartTotal: { fontSize: 9, fontFamily: 'Outfit_600SemiBold' },
  chartBarTrack: { width: '100%', flex: 1, borderRadius: 6, justifyContent: 'flex-end', overflow: 'hidden' },
  chartBar: { width: '100%', borderRadius: 6 },
  chartLabel: { fontSize: 10, fontFamily: 'Outfit_500Medium' },
  typeRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10 },
  typeInfo: { gap: 2 },
  typeName: { fontSize: 14, fontFamily: 'Outfit_600SemiBold' },
  typeJobs: { fontSize: 12, fontFamily: 'Outfit_400Regular' },
  typeTotal: { fontSize: 14, fontFamily: 'Outfit_700Bold' },
