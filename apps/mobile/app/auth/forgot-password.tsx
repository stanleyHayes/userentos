...
const s = StyleSheet.create({
  ...
  backRowText: { fontSize: 14, fontFamily: 'Outfit_400Regular' },
  ...
  input: { height: 52, paddingHorizontal: spacing.md, fontSize: 15, fontFamily: 'Outfit_400Regular' },
  ...
  successTitle: { fontSize: 24, fontFamily: 'Outfit_800ExtraBold', marginBottom: spacing.sm },
  successDesc: { fontSize: 14, fontFamily: 'Outfit_400Regular', textAlign: 'center', lineHeight: 22, maxWidth: 300, marginBottom: spacing.lg },
  successEmail: { fontFamily: 'Outfit_700Bold' },
  tryAgainBtn: { marginBottom: spacing.md },
  tryAgainText: { fontSize: 14, fontFamily: 'Outfit_600SemiBold' },
  backLink: { fontSize: 14, fontFamily: 'Outfit_400Regular' },
})
