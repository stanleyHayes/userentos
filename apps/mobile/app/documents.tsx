...
const s = StyleSheet.create({
  ...
  uploadButtonText: { fontSize: 15, fontFamily: 'Outfit_600SemiBold', color: '#ffffff' },
  ...
  docInfo: { flex: 1 },
  docName: { fontSize: 14, fontFamily: 'Outfit_600SemiBold' },
  ...
  categoryText: { fontSize: 10, fontFamily: 'Outfit_600SemiBold', textTransform: 'capitalize' },
