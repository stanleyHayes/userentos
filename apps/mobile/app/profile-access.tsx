        ...
        {filters.map((f) => (
          ...
          >
            <Text style={[
              s.filterText,
              { color: c.muted },
              filter === f && { color: c.primary, fontFamily: 'Outfit_600SemiBold' },
            ]}>
...
const s = StyleSheet.create({
  container: { flex: 1 },
  description: { fontSize: 13, fontFamily: 'Outfit_400Regular', paddingHorizontal: spacing.md, paddingTop: spacing.sm, paddingBottom: spacing.xs },
  ...
  filterText: { fontSize: 12, fontFamily: 'Outfit_500Medium', textTransform: 'capitalize' },
  ...
  cardEmail: { fontSize: 12, fontFamily: 'Outfit_400Regular', marginTop: 1 },
  statusBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  statusText: { fontSize: 11, fontFamily: 'Outfit_600SemiBold', textTransform: 'capitalize' },
  meta: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginTop: 10 },
  metaItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  metaText: { fontSize: 11, fontFamily: 'Outfit_400Regular' },
  messageBox: { marginTop: 10, padding: 10 },
  messageText: { fontSize: 12, fontFamily: 'Outfit_400Regular', fontStyle: 'italic' },
  ...
  actionBtnText: { fontSize: 13, fontFamily: 'Outfit_600SemiBold', color: '#ffffff' },
  hintBox: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8, flex: 1 },
  hintText: { fontSize: 12, fontFamily: 'Outfit_500Medium' },
  center: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingTop: 60 },
  empty: { alignItems: 'center', paddingTop: 60, gap: 8 },
  emptyTitle: { fontSize: 16, fontFamily: 'Outfit_700Bold' },
  emptyDesc: { fontSize: 13, fontFamily: 'Outfit_400Regular', textAlign: 'center', paddingHorizontal: 40 },
})
