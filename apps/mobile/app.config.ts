 ...
 * "Android push"). A local ./google-services.json also works for local builds.
 * Without either the build still succeeds, but Android push registration
 * fails (expo-notifications needs Firebase for the device token).
 */
