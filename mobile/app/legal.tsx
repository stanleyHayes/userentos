...
const s = StyleSheet.create({
  ...
  aiButtonText: { fontSize: 14, fontFamily: 'Outfit_600SemiBold', color: '#ffffff' },
  ...
  clearFilter: { fontSize: 13, fontFamily: 'Outfit_500Medium' },
  emptyContainer: { alignItems: 'center', padding: spacing.xl, gap: spacing.sm },
  emptyText: { fontSize: 16, fontFamily: 'Outfit_600SemiBold' },
  emptySubText: { fontSize: 13, textAlign: 'center', fontFamily: 'Outfit_400Regular' },
  ...
  articleTitle: { fontSize: 14, fontFamily: 'Outfit_600SemiBold' },
  ...
  categoryBadgeText: { fontSize: 11, fontFamily: 'Outfit_600SemiBold' },
  lawRef: { fontSize: 11, fontFamily: 'Outfit_400Regular' },
  ...
  simplifiedLabel: { fontSize: 12, fontFamily: 'Outfit_700Bold', marginBottom: 6 },
  simplifiedText: { fontSize: 13, fontFamily: 'Outfit_400Regular', lineHeight: 20 },
  fullTextLabel: { fontSize: 12, fontFamily: 'Outfit_700Bold', marginBottom: 6 },
  fullText: { fontSize: 13, fontFamily: 'Outfit_400Regular', lineHeight: 20 },
  tagsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: spacing.md },
  tag: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  tagText: { fontSize: 11, fontFamily: 'Outfit_500Medium' },
  effectiveDate: { fontSize: 11, fontFamily: 'Outfit_400Regular', marginTop: spacing.sm },
})
