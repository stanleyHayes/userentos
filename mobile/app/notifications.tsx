...
const s = StyleSheet.create({
  ...
  unreadLabel: { fontSize: 13, fontFamily: 'Outfit_600SemiBold' },
  ...
  cardBody: { flex: 1 },
  cardTitle: { fontSize: 14, fontFamily: 'Outfit_500Medium' },
  cardTitleUnread: { fontFamily: 'Outfit_700Bold' },
  cardMessage: { fontSize: 13, marginTop: 2, lineHeight: 18, fontFamily: 'Outfit_400Regular' },
  cardDate: { fontSize: 11, marginTop: 4, fontFamily: 'Outfit_400Regular' },
