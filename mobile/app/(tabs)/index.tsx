...
const s = StyleSheet.create({
  ...
  greeting: { color: 'rgba(255,255,255,0.6)', fontSize: 14, fontFamily: 'Outfit_400Regular' },
  name: { color: '#ffffff', fontSize: 26, fontFamily: 'Outfit_800ExtraBold', marginTop: 2 },
  ...
  roleText: { color: '#ffffff', fontSize: 11, fontFamily: 'Outfit_600SemiBold', textTransform: 'capitalize' },
  ...
  statLabel: { fontSize: 10, fontFamily: 'Outfit_500Medium' },
  ...
  residenceTitle: { fontSize: 14, fontFamily: 'Outfit_700Bold' },
  activeBadge: { backgroundColor: '#10b98118', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
  activeBadgeText: { fontSize: 10, fontFamily: 'Outfit_600SemiBold', color: '#10b981' },
  residenceDetails: { flexDirection: 'row', alignItems: 'center', paddingLeft: 44 },
  residenceDetailItem: { gap: 1 },
  residenceDetailLabel: { fontSize: 9, fontFamily: 'Outfit_500Medium', textTransform: 'uppercase', letterSpacing: 0.5 },
  residenceDetailValue: { fontSize: 12, fontFamily: 'Outfit_600SemiBold' },
  residenceDivider: { width: 1, height: 24, marginHorizontal: 12, opacity: 0.3 },
  residenceSub: { fontSize: 12, fontFamily: 'Outfit_400Regular', paddingLeft: 44 },
  ...
  cardPct: { fontSize: 16, fontFamily: 'Outfit_800ExtraBold' },
  progressBar: { height: 8, borderRadius: 4, overflow: 'hidden' },
  progressFill: { height: '100%', borderRadius: 4 },
  progressText: { fontSize: 11, fontFamily: 'Outfit_400Regular', marginTop: 6 },
  ...
  actionLabel: { fontSize: 11, fontFamily: 'Outfit_600SemiBold' },

  // Saved properties
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  seeAll: { fontSize: 12, fontFamily: 'Outfit_600SemiBold' },
  ...
  savedTitle: { fontSize: 13, fontFamily: 'Outfit_600SemiBold' },
  savedLocationRow: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  savedLocation: { fontSize: 10, fontFamily: 'Outfit_400Regular', flex: 1 },
  savedBottom: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 4 },
  savedPrice: { fontSize: 13, fontFamily: 'Outfit_800ExtraBold' },
  savedDetails: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  savedDetailText: { fontSize: 10, fontFamily: 'Outfit_400Regular' },
})
