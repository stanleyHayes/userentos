...
const s = StyleSheet.create({
  ...
  aprText: { fontSize: 11, fontFamily: 'Outfit_700Bold' },
  ...
  applyBtnText: { color: '#fff', fontSize: 14, fontFamily: 'Outfit_600SemiBold' },
  ...
  summaryRow: { fontSize: 12, fontFamily: 'Outfit_400Regular' },
  summaryBold: { fontFamily: 'Outfit_700Bold' },
