...
const s = StyleSheet.create({
  ...
  summaryValue: { fontSize: 16, fontFamily: 'Outfit_800ExtraBold' },
  summaryLabel: { fontSize: 10, fontFamily: 'Outfit_400Regular', marginTop: 2 },
  summaryDivider: { width: 1, marginVertical: 4 },
  list: { padding: spacing.md, gap: spacing.sm, paddingBottom: 40 },
  card: { flexDirection: 'row', alignItems: 'center', padding: 12, gap: 10 },
  avatar: { width: 42, height: 42, borderRadius: 21, justifyContent: 'center', alignItems: 'center' },
  avatarText: { color: '#fff', fontSize: 14, fontFamily: 'Outfit_700Bold' },
  cardBody: { flex: 1 },
  nameRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  name: { fontSize: 14, fontFamily: 'Outfit_600SemiBold' },
  email: { fontSize: 11, fontFamily: 'Outfit_400Regular', marginTop: 1 },
  propRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 },
  propText: { fontSize: 11, fontFamily: 'Outfit_400Regular', flex: 1 },
  rentText: { fontSize: 11, fontFamily: 'Outfit_700Bold' },
  rightCol: { alignItems: 'flex-end', gap: 4 },
  statusDot: { width: 8, height: 8, borderRadius: 4 },
  paidText: { fontSize: 10, fontFamily: 'Outfit_700Bold' },
  ...
  detailAvatarText: { color: '#fff', fontSize: 20, fontFamily: 'Outfit_700Bold' },
  detailName: { fontSize: 18, fontFamily: 'Outfit_700Bold' },
  detailEmail: { fontSize: 13, fontFamily: 'Outfit_400Regular' },
  detailPhone: { fontSize: 12, fontFamily: 'Outfit_400Regular' },
  ...
  sectionLabel: { fontSize: 10, fontFamily: 'Outfit_600SemiBold', textTransform: 'uppercase', letterSpacing: 1, marginBottom: spacing.sm },
  ...
  agreementTitle: { fontSize: 13, fontFamily: 'Outfit_600SemiBold' },
  agreementDates: { fontSize: 10, fontFamily: 'Outfit_400Regular', marginTop: 2 },
  statusBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  statusBadgeText: { fontSize: 10, fontFamily: 'Outfit_600SemiBold', textTransform: 'capitalize' },
  agreementStats: { flexDirection: 'row', gap: 12, marginTop: 8 },
  agreementRent: { fontSize: 12, fontFamily: 'Outfit_700Bold' },
  agreementPaid: { fontSize: 11, fontFamily: 'Outfit_600SemiBold' },
  agreementPayments: { fontSize: 11, fontFamily: 'Outfit_400Regular' },
  ...
  actionBtnText: { color: '#fff', fontSize: 13, fontFamily: 'Outfit_600SemiBold' },
})
