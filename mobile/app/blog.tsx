...
const s = StyleSheet.create({
  ...
  tagText: { fontSize: 10, fontFamily: 'Outfit_600SemiBold', textTransform: 'capitalize' },
  title: { fontSize: 16, fontFamily: 'Outfit_700Bold', lineHeight: 22 },
  excerpt: { fontSize: 13, fontFamily: 'Outfit_400Regular', lineHeight: 19 },
