...
const s = StyleSheet.create({
  ...
  subcopy: { fontSize: 13, fontFamily: 'Outfit_400Regular' },
  ...
  loadingText: { fontSize: 13, fontFamily: 'Outfit_400Regular' },
  empty: { alignItems: 'center', marginTop: 60, gap: spacing.sm },
  emptyTitle: { fontSize: 16, fontFamily: 'Outfit_700Bold' },
  emptySubtitle: { fontSize: 13, fontFamily: 'Outfit_400Regular', textAlign: 'center', paddingHorizontal: spacing.xl },
  ...
  listingTitle: { fontSize: 12, fontFamily: 'Outfit_500Medium', flex: 1 },
  listingPrice: { fontSize: 12, fontFamily: 'Outfit_700Bold' },
  promoText: { fontSize: 11, fontFamily: 'Outfit_700Bold', color: '#f59e0b' },
  moreText: { fontSize: 11, fontFamily: 'Outfit_600SemiBold' },
  phoneRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 2 },
  phone: { fontSize: 12, fontFamily: 'Outfit_500Medium' },
  ...
  modalMeta: { fontSize: 12, fontFamily: 'Outfit_400Regular' },
  modalDesc: { fontSize: 13, fontFamily: 'Outfit_400Regular', lineHeight: 19, marginBottom: spacing.sm },
  sectionLabel: { fontSize: 9, fontFamily: 'Outfit_700Bold', letterSpacing: 0.5, marginTop: spacing.md, marginBottom: spacing.sm },
  modalListing: { padding: 10, gap: 4, marginBottom: 6 },
  listingDesc: { fontSize: 11, fontFamily: 'Outfit_400Regular', lineHeight: 16 },
  contactRow: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 12, marginBottom: 6 },
  contactText: { fontSize: 13, fontFamily: 'Outfit_600SemiBold' },

  ratingValue: { fontSize: 12, fontFamily: 'Outfit_700Bold' },
  ratingCount: { fontSize: 11, fontFamily: 'Outfit_400Regular' },
  ...
  quoteBtnText: { color: '#fff', fontSize: 14, fontFamily: 'Outfit_700Bold' },
  ...
  reviewBody: { fontSize: 12, fontFamily: 'Outfit_400Regular', lineHeight: 17 },
  ...
  writeBtnText: { fontSize: 13, fontFamily: 'Outfit_600SemiBold' },
  inquirySub: { fontSize: 13, fontFamily: 'Outfit_400Regular', lineHeight: 19, marginBottom: spacing.sm },
  inquiryInput: { paddingHorizontal: spacing.md, paddingVertical: 10, fontSize: 14, fontFamily: 'Outfit_400Regular', minHeight: 70, textAlignVertical: 'top', marginBottom: spacing.sm },
  formError: { fontSize: 12, fontFamily: 'Outfit_500Medium', marginBottom: spacing.sm },
  sentWrap: { alignItems: 'center', gap: spacing.sm, paddingVertical: spacing.md },
  sentTitle: { fontSize: 15, fontFamily: 'Outfit_700Bold', textAlign: 'center' },
  sentSub: { fontSize: 13, fontFamily: 'Outfit_400Regular', textAlign: 'center' },
})
