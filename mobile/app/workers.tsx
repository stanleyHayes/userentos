...
const s = StyleSheet.create({
  ...
  name: { fontSize: 15, fontFamily: 'Outfit_700Bold' },
  emergencyBadge: { paddingHorizontal: 6, paddingVertical: 1, borderRadius: 4 },
  emergencyText: { fontSize: 9, fontFamily: 'Outfit_700Bold' },
  meta: { fontSize: 12, fontFamily: 'Outfit_400Regular', marginTop: 1 },
  statsRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 },
  statText: { fontSize: 12, fontFamily: 'Outfit_500Medium' },
  divider: { marginHorizontal: 4 },
  rate: { fontSize: 13, fontFamily: 'Outfit_700Bold', marginTop: 4 },
