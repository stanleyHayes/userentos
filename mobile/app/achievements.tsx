...
const s = StyleSheet.create({
  ...
  heading: { fontSize: 22, fontFamily: 'Outfit_800ExtraBold' },
  sub: { fontSize: 12, fontFamily: 'Outfit_400Regular', marginTop: 2 },
  unlockBadge: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
  unlockText: { fontSize: 12, fontFamily: 'Outfit_700Bold' },
  ...
  ringValue: { fontSize: 28, fontFamily: 'Outfit_800ExtraBold' },
  ringLabel: { fontSize: 10, fontFamily: 'Outfit_500Medium' },
  streakStats: { gap: 6 },
  streakStatBox: { paddingVertical: 8, paddingHorizontal: 14, minWidth: 90, alignItems: 'center' },
  streakStatLabel: { fontSize: 10, fontFamily: 'Outfit_500Medium', textTransform: 'uppercase' },
  streakStatValue: { fontSize: 18, fontFamily: 'Outfit_800ExtraBold' },
  streakHint: { fontSize: 11, fontFamily: 'Outfit_400Regular', textAlign: 'center', marginTop: spacing.sm },
  ...
  rankText: { fontSize: 11, fontFamily: 'Outfit_800ExtraBold' },
  lbName: { flex: 1, fontSize: 13, fontFamily: 'Outfit_700Bold' },
  tierBadge: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  tierBadgeText: { fontSize: 9, fontFamily: 'Outfit_700Bold', textTransform: 'capitalize' },
  lbStreak: { fontSize: 12, fontFamily: 'Outfit_700Bold' },
  ...
  badgeTitle: { fontSize: 12, fontFamily: 'Outfit_700Bold', marginTop: 4 },
  badgeDesc: { fontSize: 10, fontFamily: 'Outfit_400Regular', lineHeight: 14 },
  badgeTier: { fontSize: 9, fontFamily: 'Outfit_700Bold', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 2 },
  muted: { fontSize: 12, fontFamily: 'Outfit_500Medium' },
})
