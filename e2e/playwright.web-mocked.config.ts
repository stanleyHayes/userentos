...
export default defineConfig({ ...base, webServer: undefined, testMatch: ['web-content-reports.spec.ts', 'admin-offplan-review.spec.ts', 'web-property-review.spec.ts', 'web-dashboard-figures.spec.ts'] })
