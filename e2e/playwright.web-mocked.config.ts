...
export default defineConfig({ ...base, webServer: undefined, testMatch: ['web-content-reports.spec.ts', 'admin-offplan-review.spec.ts', 'web-sponsored-labels.spec.ts', 'web-documents.spec.ts', 'public-storefront.spec.ts'] })
